<h2><a href="https://leetcode.com/problems/valid-number/">65. Valid Number</a></h2><h3>Hard</h3><hr><div bis_skin_checked="1"><p>A <strong>valid number</strong> can be split up into these components (in order):</p>
